                  ...
                  <div class="col-12 col-md-4 border-top-0 border-right-0 border-left-0">
                    <div class="form-group border-top-0 border-right-0 border-left-0">
                      ...
                      <div class="form-check">
                        ...
                        <input class="form-check-input col-6" type="checkbox" name="finance"
                      ...
                      <div class="form-check">
                        ...
                        <input class="form-check-input col-6" type="checkbox" name="distance"
                      ...
                      <div class="form-check">
                        ...
                        <input class="form-check-input col-6" type="checkbox" name="treatment"
